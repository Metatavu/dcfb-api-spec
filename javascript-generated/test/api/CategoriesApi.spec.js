...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DcfbApiClient.CategoriesApi();
  });
  ...
  describe('CategoriesApi', function() {
    ...
    describe('findCategory', function() {
      it('should call findCategory successfully', function(done) {
        //uncomment below and update the code to test findCategory
        //instance.findCategory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
