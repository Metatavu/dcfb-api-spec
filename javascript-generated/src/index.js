...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Address', 'model/BadRequest', 'model/Category', 'model/CategoryListSort', 'model/Coordinate', 'model/Forbidden', 'model/Image', 'model/InternalServerError', 'model/Item', 'model/ItemListSort', 'model/ItemReservation', 'model/LocalizedValue', 'model/Location', 'model/LocationListSort', 'model/Meta', 'model/NotFound', 'model/NotImplemented', 'model/Price', 'model/PurchaseRequest', 'api/CategoriesApi', 'api/ItemsApi', 'api/LocationsApi', 'api/PurchaseRequestsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Address'), require('./model/BadRequest'), require('./model/Category'), require('./model/CategoryListSort'), require('./model/Coordinate'), require('./model/Forbidden'), require('./model/Image'), require('./model/InternalServerError'), require('./model/Item'), require('./model/ItemListSort'), require('./model/ItemReservation'), require('./model/LocalizedValue'), require('./model/Location'), require('./model/LocationListSort'), require('./model/Meta'), require('./model/NotFound'), require('./model/NotImplemented'), require('./model/Price'), require('./model/PurchaseRequest'), require('./api/CategoriesApi'), require('./api/ItemsApi'), require('./api/LocationsApi'), require('./api/PurchaseRequestsApi'));
  }
}(function(ApiClient, Address, BadRequest, Category, CategoryListSort, Coordinate, Forbidden, Image, InternalServerError, Item, ItemListSort, ItemReservation, LocalizedValue, Location, LocationListSort, Meta, NotFound, NotImplemented, Price, PurchaseRequest, CategoriesApi, ItemsApi, LocationsApi, PurchaseRequestsApi) {
  'use strict';
